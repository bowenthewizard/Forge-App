...
export default function Page() {
  ...
  return (
    ...
    <main className="mx-auto max-w-md min-h-screen flex flex-col bg-bg overflow-x-hidden">
      <StatusBar />

      <div className="flex-1 overflow-y-auto no-scrollbar pb-[calc(76px+env(safe-area-inset-bottom,0px))]">
        {tab === "home" && <HomeScreen />}
